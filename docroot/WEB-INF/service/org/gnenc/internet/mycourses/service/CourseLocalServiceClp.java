...
public class CourseLocalServiceClp implements CourseLocalService {
	...
	public org.gnenc.internet.mycourses.model.Course getCourse(long id)
		...
		MethodHandler methodHandler = new MethodHandler(_getCourseMethodKey8, id);
	...
	public java.util.List<org.gnenc.internet.mycourses.model.Course> getCourses(
		...
		MethodHandler methodHandler = new MethodHandler(_getCoursesMethodKey9,
				start, end);
		...
		return (java.util.List<org.gnenc.internet.mycourses.model.Course>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public int getCoursesCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getCoursesCountMethodKey10);
	...
	public org.gnenc.internet.mycourses.model.Course updateCourse(
		...
		MethodHandler methodHandler = new MethodHandler(_updateCourseMethodKey11,
				course);
	...
	public org.gnenc.internet.mycourses.model.Course updateCourse(
		...
		MethodHandler methodHandler = new MethodHandler(_updateCourseMethodKey12,
				course, merge);
	...
	public org.gnenc.internet.mycourses.model.Course getCourseByEntity(
		...
		try {
			...
			if (t instanceof org.gnenc.internet.mycourses.NoSuchCourseException) {
				throw (org.gnenc.internet.mycourses.NoSuchCourseException)t;
			}
	...
	private MethodKey _addCourseMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			"addCourse", org.gnenc.internet.mycourses.model.Course.class);
	private MethodKey _createCourseMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			"createCourse", long.class);
	private MethodKey _deleteCourseMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteCourse", long.class);
	private MethodKey _deleteCourseMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteCourse", org.gnenc.internet.mycourses.model.Course.class);
	...
	private MethodKey _getCourseMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
			"getCourse", long.class);
	private MethodKey _getCoursesMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
			"getCourses", int.class, int.class);
	private MethodKey _getCoursesCountMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
			"getCoursesCount");
	private MethodKey _updateCourseMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
