...
/**
 * The base model implementation for the Host service. Represents a row in the
 * &quot;MC_Host&quot; database table, with each column mapped to a property of
 * this class.
 * 
 * <p>
 * This implementation and its corresponding interface
 * {@link org.gnenc.internet.mycourses.model.HostModel} exist only as a
 * container for the default property accessors generated by ServiceBuilder.
 * Helper methods and all application logic should be put in {@link HostImpl}.
 * </p>
 * 
 * <p>
 * Never modify or reference this class directly. All methods that expect a host
 * model instance should use the {@link org.gnenc.internet.mycourses.model.Host}
 * interface instead.
 * </p>
 * 
...
public class HostModelImpl extends BaseModelImpl<Host> implements HostModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.entity.cache.enabled.org.gnenc.internet.mycourses.model.Host"),
					true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.finder.cache.enabled.org.gnenc.internet.mycourses.model.Host"),
					true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil
			.getLong(com.liferay.util.service.ServiceProps
					.get("lock.expiration.time.org.gnenc.internet.mycourses.model.Host"));
	...
	public Host toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (Host) Proxy
					.newProxyInstance(Host.class.getClassLoader(),
	...
	public String toXmlString() {
		...
		sb.append("<column><column-name>hostId</column-name><column-value><![CDATA[");
		sb.append(getHostId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>entityId</column-name><column-value><![CDATA[");
		sb.append(getEntityId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>remoteEntityId</column-name><column-value><![CDATA[");
		sb.append(getRemoteEntityId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>peerId</column-name><column-value><![CDATA[");
		sb.append(getPeerId());
		sb.append("]]></column-value></column>");
