...
public class CourseModelImpl extends BaseModelImpl<Course>
	...
	public static final String TABLE_SQL_CREATE = "create table MC_Course (id_ LONG not null primary key,courseId LONG,name VARCHAR(75) null,siteId LONG)";
	...
	public Object clone() {
		...
		courseImpl.setSiteId(getSiteId());
