 ...
 * {@link org.gnenc.internet.mycourses.model.CourseModel} exist only as a
 * container for the default property accessors generated by ServiceBuilder.
 * Helper methods and all application logic should be put in {@link CourseImpl}.
 * </p>
 * 
 * <p>
 * Never modify or reference this class directly. All methods that expect a
 * course model instance should use the
 * {@link org.gnenc.internet.mycourses.model.Course} interface instead.
 * </p>
 * 
 ...
 * @generated
 */
public class CourseModelImpl extends BaseModelImpl<Course> implements
		CourseModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.entity.cache.enabled.org.gnenc.internet.mycourses.model.Course"),
					true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.finder.cache.enabled.org.gnenc.internet.mycourses.model.Course"),
					true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil
			.getLong(com.liferay.util.service.ServiceProps
					.get("lock.expiration.time.org.gnenc.internet.mycourses.model.Course"));
	...
	public Course toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (Course) Proxy.newProxyInstance(Course.class
					.getClassLoader(), new Class[] { Course.class },
	...
	public int compareTo(Course course) {
		...
		value = getName().toLowerCase().compareTo(
