...
/**
 * The base implementation of the host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.gnenc.internet.mycourses.service.impl.HostLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link org.gnenc.internet.mycourses.service.HostLocalServiceUtil} to access the host local service.
 * </p>
 *
 ...
 * @generated
 */
public abstract class HostLocalServiceBaseImpl implements HostLocalService {
	/**
	...
	public Host addHost(Host host) throws SystemException {
		...
		return hostPersistence.update(host, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHost(long hostId) throws PortalException, SystemException {
		hostPersistence.remove(hostId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHost(Host host) throws SystemException {
		hostPersistence.remove(host);
	}
	...
	public Host updateHost(Host host) throws SystemException {
		...
		return hostPersistence.update(host, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Host updateHost(Host host, boolean merge) throws SystemException {
		host.setNew(false);

		return hostPersistence.update(host, merge);
	}
